...
Public Class InsertarHoteles
    ...
    Private Sub Registrar_Click(sender As Object, e As EventArgs) Handles Registrar.Click
        ...
        str = "Insert into Hoteles(codlugar,nomhotel,costonoche) values('" + lug2 + "','" + nom2 + "','" + cos2 + "')"
        INSERTAR(str)
        Nom.Clear()
        Cos.Clear()
    End Sub

    Private Sub InsertarHoteles_Load(sender As Object, e As EventArgs) Handles MyBase.Load
